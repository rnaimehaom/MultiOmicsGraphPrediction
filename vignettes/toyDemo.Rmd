...
for(sample in rownames(inputData@sampleMetaData)){
  ...
  pred.cv <- MultiOmicsGraphPrediction::RunPairwisePrediction(inputResults = optimalModel.cv@model.input@model.properties,
                                                         inputData = data$training,
                                                         stype = "age",
                                                         independentVarType = 2,
                                                         outcomeType = 1)
  pred.cv.test <- MultiOmicsGraphPrediction::RunPairwisePrediction(inputResults = optimalModel.cv@model.input@model.properties,
  ...
  metafeaturesTest <- MultiOmicsGraphPrediction::GetTestMetaFeatures(predictionsTrain = pred.cv,
                                                                 ...
                                                                 k = 2, eigStep = 1,
                                                                 modelStats = optimalModel.cv@model.input@model.properties,
                                                                 colIdInd = "databaseId",
                                                                 colIdOut = "databaseId")

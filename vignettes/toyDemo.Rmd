...
for(sample in rownames(inputData@sampleMetaData)){
  ...
  # # Run prediction.
  # myres.cv <- IntLIM::RunIntLim(inputData = data$training,stype=stype,
  #                                save.covar.pvals = TRUE, 
  #                                outcome = outcomeType, 
  ...
  # peak.r2.cv <- myres.r2.density.cv$x[which.max(myres.r2.density.cv$y)]
  # myres.r2 <- IntLIM::ProcessResults(inputResults = myres.cv, inputData = data$training, 
  #                                        pvalcutoff = 1, rsquaredCutoff = peak.r2.cv)
  # # Build graph.
  # coreg.r2.cv <- MultiOmicsGraphPrediction::BuildCoRegulationGraph(myres.r2.cv)
  # MultiOmicsGraphPrediction::PlotCoRegulationGraph(coreg.r2.cv, "", saveInFile = "")
  ...
  #                                                                        predictions = pred.cv)
  # metaFeatures.cv <- MultiOmicsGraphPrediction::GetMetaFeatures(predictions = pred.cv, 
  #                                                                stype = stype,
  #                                                                inputData = data$training, 
  ...
  #                                                    coregulationGraph = coreg.r2.cv,
  #                                                    inputData = data$training, 
  #                                                    stype.class = "numeric",
  #                                                    stype = stype,
  #                                                    edgeTypeList = c("shared.outcome.analyte", "shared.independent.analyte"),
  #                                                    metaFeatures = metaFeatures.cv,
